...
let batiment_list =
  [| Maison; Carriere; Scierie; Ferme; Puit; Auberge; Statue |]
...
type arbrepos =
  | Nil
  | Nodi of (batiment * batiment * int * bool) list * arbrepos
...
type generation =
  arbre array * arbrepos array * carte * position array * evaluation
